        ...
        <motion.div key={activeTab} initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -12 }}
          ...
          {activeTab === 'model_probe' && (
            <div className="space-y-4">
              {modelProbe ? (
                modelProbe.degenerate ? (
                  /* Degenerate probe warning */
                  <div className="space-y-4">
                    <div className="rounded-2xl p-6 border border-signal-amber/40 bg-signal-amber/5">
                      <div className="flex items-start gap-4">
                        <div className="text-signal-amber text-2xl flex-shrink-0">⚠</div>
                        <div>
                          <div className="text-signal-amber font-mono text-sm font-semibold mb-2">
                            Model Probe Inconclusive — Synthetic Data Out-of-Distribution
                          </div>
